...
#SBATCH --job-name=spot-run-13240
#SBATCH --output=/sdf/home/a/abrought/run5/BF/output/spotout-run-13240.txt
#SBATCH --error=/sdf/home/a/abrought/run5/BF/output/spoterr-run-13240.txt
#SBATCH --ntasks=1
...
pipetask run \
        ...
        -o u/abrought/BF/run_13240/R24_S11/corrected \
        -p ${YAML}/gridFit.yaml \
        --register-dataset-types
 
cp ${YAML}/gridFit.yaml ${REPO}/u/abrought/BF/run_13240/R24_S11/corrected
