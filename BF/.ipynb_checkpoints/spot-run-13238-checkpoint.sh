...
#SBATCH --job-name=spot-run-13238
#SBATCH --output=/sdf/home/a/abrought/run5/BF/output/spotout-run-13238.txt
#SBATCH --error=/sdf/home/a/abrought/run5/BF/output/spoterr-run-13238.txt
#SBATCH --ntasks=1
...
pipetask run \
        ...
        -o u/abrought/BF/run_13238/R21_S02/corrected \
        -p ${YAML}/gridFit.yaml \
        --register-dataset-types
