...
weekly=w_2022_11
source /cvmfs/sw.lsst.eu/linux-x86_64/lsst_distrib/${weekly}/loadLSST-ext.bash
setup lsst_distrib
setup -r /sdf/group/lsst/software/IandT/bps_env/gen3_workflow -j
wq_env=/sdf/group/lsst/software/IandT/bps_env/wq
...
# Generate SFLAT
bps submit ${YAML}/bps_cpFlat.yaml
# pipetask run \
#    -j 25 \
...
#pipetask run \
#    -j 25 \
#    -d "instrument='LSSTCam' AND exposure.observation_type='dark' AND detector in (9, 23, 31, 83, 112, 136) AND exposure.science_program IN ('13162')" \
#    -b ${REPO}/butler.yaml \
