...
#SBATCH --output=/sdf/home/a/abrought/run5/BF/output/out16.txt
#SBATCH --error=/sdf/home/a/abrought/run5/BF/output/err16.txt
#SBATCH --ntasks=6
...
pipetask run  \
    ...
    -b ${REPO} \
    -i u/abrought/BF/2023.04.28/ptc.2023.04.28.R24-S11.trunc_to_pcti,u/abrought/BF/2023.05.15/bfk.2023.05.15.R24-S11.cov_model_60000adu.noForceZeroSum,${SBIAS},${SDARK},${DEFECTS},${CTI},${LINEARITY},LSSTCam/raw/all \
    -o u/abrought/BF/2023.05.15/ptc.2023.05.15.R24-S11.bfcorrected.cov_model_60000adu.noForceZeroSum \
    -p ${CONFIG}/cpPtc.yaml \
