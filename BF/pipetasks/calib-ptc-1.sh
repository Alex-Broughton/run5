...
#source /cvmfs/sw.lsst.eu/linux-x86_64/lsst_distrihistb/w_2023_09/loadLSST-ext.bash
#setup lsst_distrib
...
pipetask run  \
    ...
    -o u/abrought/BF/2023.07.19/ptc.R03-S12.bfcorrected.40000adu.retest.v2 \
    -p ${CONFIG}/cpPtc.yaml \
        --config isr:connections.newBFKernel='bfk' \
    --register-dataset-types
