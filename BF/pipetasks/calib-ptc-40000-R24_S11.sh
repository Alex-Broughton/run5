...
#SBATCH --output=/sdf/home/a/abrought/run5/BF/output/out8.txt
#SBATCH --error=/sdf/home/a/abrought/run5/BF/output/err8.txt
#SBATCH --ntasks=6
...
pipetask run  \
    ...
    -o u/abrought/BF/2023.05.15/ptc.2023.05.15.R24-S11.bfcorrected.cov_model_40000adu.noForceZeroSum \
    -p ${CONFIG}/cpPtc.yaml \
