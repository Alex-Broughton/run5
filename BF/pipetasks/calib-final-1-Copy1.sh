...
#SBATCH --output=/sdf/home/a/abrought/run5/BF/output/out101.txt
#SBATCH --error=/sdf/home/a/abrought/run5/BF/output/err101.txt
#SBATCH --ntasks=6
...
source /cvmfs/sw.lsst.eu/linux-x86_64/lsst_distrib/w_2023_24/loadLSST-ext.bash
setup lsst_distrib
setup -j -r /sdf/home/a/abrought/alternate_branches/recommended/cp_pipe
setup -j -r /sdf/home/a/abrought/alternate_branches/recommended/ip_isr
...
pipetask run  \
    ...
    -b ${REPO} \
    -i ${SBIAS},${SDARK},${DEFECTS},${LINEARITY},${CTI},LSSTCam/raw/all \
    -o u/abrought/BF/2023.06.16/ptc.R03-S12.trunc_to_pcti.fullnoisematrix.8x8.deferredchargeapplygainTrue.applyGainTrue \
    -p ${CONFIG}/cpPtc-R03-S12-pCTI-Copy1.yaml \
    --register-dataset-types
...
#    -b ${REPO} \
#    -i ${SBIAS},${SDARK},${DEFECTS},${LINEARITY},${CTI},LSSTCam/raw/all \
#    -o u/abrought/BF/2023.06.16/ptc.R21-S02.trunc_to_pcti.fullnoisematrix \
#    -p ${CONFIG}/cpPtc-R21-S02-pCTI.yaml \
#    --register-dataset-types
#
#
#
...
#    -b ${REPO} \
#    -i ${SBIAS},${SDARK},${DEFECTS},${LINEARITY},${CTI},LSSTCam/raw/all \
#    -o u/abrought/BF/2023.06.16/ptc.R02-S00.trunc_to_ptc.fullnoisematrix \
...
#    -b ${REPO} \
#    -i ${SBIAS},${SDARK},${DEFECTS},${LINEARITY},${CTI},LSSTCam/raw/all \
#    -o u/abrought/BF/2023.06.16/ptc.R21-S02.trunc_to_ptc.fullnoisematrix \
