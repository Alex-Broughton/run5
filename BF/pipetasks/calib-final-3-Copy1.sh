...
#SBATCH --output=/sdf/home/a/abrought/run5/BF/output/out5.txt
#SBATCH --error=/sdf/home/a/abrought/run5/BF/output/err5.txt
#SBATCH --ntasks=6
...
export CONFIG=/sdf/home/a/abrought/run5/BF/config2s
export SBIAS=LSSTCam/calib/DM-36442/bias.20221026b
export SDARK=LSSTCam/calib/DM-36442/dark.20221026b
export DEFECTS=LSSTCam/calib/DM-36442/defects.20221026b
export LINEARITY=LSSTCam/calib/DM-36442/linearity.20221026b
...
pipetask run  \
       ...
       -b ${REPO} \
       -i ${SBIAS},${SDARK},${DEFECTS},${LINEARITY},${CTI},LSSTCam/raw/all \
       -o u/abrought/BF/2023.10.07/ptc.R03-S12.trunc_to_pCTI.fullnoisematrix.15x15.new_calibs \
       -p ${CONFIG}/cpPtc-R03-S12-pCTI.yaml \
       --register-dataset-types
...
#      -b ${REPO} \
#      -i ${SBIAS},${SDARK},${DEFECTS},${LINEARITY},${CTI},LSSTCam/raw/all \
#      -o u/abrought/BF/2023.07.19/ptc.R21-S02.trunc_to_pcti.fullnoisematrix.15x15 \
#      -p ${CONFIG}/cpPtc-R21-S11-pCTI.yaml \
#      --register-dataset-types
...
#    -b ${REPO} \
#    -i ${SBIAS},${SDARK},${DEFECTS},${LINEARITY},${CTI},LSSTCam/raw/all \
#    -o u/abrought/BF/2023.07.19/ptc.R02-S00.trunc_to_ptc.fullnoisematrix \
#    -p ${CONFIG}/cpPtc-R02-S00-PTC.yaml \
#    --register-dataset-types
...
#    -b ${REPO} \
#    -i ${SBIAS},${SDARK},${DEFECTS},${LINEARITY},${CTI},LSSTCam/raw/all \
#    -o u/abrought/BF/2023.07.19/ptc.R21-S02.trunc_to_ptc.fullnoisematrix \
#    -p ${CONFIG}/cpPtc-R21-S02-PTC.yaml \
#    --register-dataset-types
