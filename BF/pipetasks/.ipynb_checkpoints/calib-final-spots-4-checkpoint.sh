...
pipetask run \
        ...
        -b ${REPO} \
        -i u/abrought/BF/2023.04.28/ptc.2023.04.28.R21-S02.trunc_to_pcti,u/abrought/BF/2023.05.15/bfk.2023.05.15.R21-S02.final,${SBIAS},${SDARK},${DEFECTS},${CTI},${LINEARITY},LSSTCam/raw/all \
        -o u/abrought/BF/2023.06.06/run_13236/R21-S02/uncorrected \
...
pipetask run \
        ...
        -b ${REPO} \
        -i u/abrought/BF/2023.04.28/ptc.2023.04.28.R21-S02.trunc_to_pcti,u/abrought/BF/2023.05.15/bfk.2023.05.15.R21-S02.final,${SBIAS},${SDARK},${DEFECTS},${CTI},${LINEARITY},LSSTCam/raw/all \
        -o u/abrought/BF/2023.06.06/run_13236/R21-S02/corrected.optimized_scale_factor \
...
pipetask run \
        ...
        -b ${REPO} \
        -i u/abrought/BF/2023.04.28/ptc.2023.04.28.R21-S02.trunc_to_pcti,u/abrought/BF/2023.05.15/bfk.2023.05.15.R21-S02.final,${SBIAS},${SDARK},${DEFECTS},${CTI},${LINEARITY},LSSTCam/raw/all \
        -o u/abrought/BF/2023.06.06/run_13238/R21-S02/corrected.optimized_scale_factor \
        -p ${CONFIG}/gridFit_corrected-new.yaml \
            --config isr:connections.newBFKernel='bfk' \
        --register-dataset-types
...
#        -d "instrument='LSSTCam' AND detector in ( 83 ) AND exposure.observation_type='spot' AND exposure.science_program IN ('13236')" \
#        -b ${REPO} \
#        -i u/abrought/BF/2023.04.28/ptc.2023.04.28.R21-S02.trunc_to_pcti,u/abrought/BF/2023.05.15/bfk.2023.05.15.R21-S02.cov_model_pcti,${SBIAS},${SDARK},${DEFECTS},${CTI},${LINEARITY},LSSTCam/raw/all \
#        -o u/abrought/BF/2023.05.15/run_13236/R21-S02/corrected.cov_model_pcti \
#        -p ${CONFIG}/gridFit_corrected-new.yaml \
#            --config isr:connections.newBFKernel='bfk' \
#        --register-dataset-types
...
#        -d "instrument='LSSTCam' AND detector in ( 83 ) AND exposure.observation_type='spot' AND exposure.science_program IN ('13236')" \
#        -b ${REPO} \
#        -i u/abrought/BF/2023.04.28/ptc.2023.04.28.R21-S02.trunc_to_ptc,u/abrought/BF/2023.05.15/bfk.2023.05.15.R21-S02.cov_model_ptc,${SBIAS},${SDARK},${DEFECTS},${CTI},${LINEARITY},LSSTCam/raw/all \
#        -o u/abrought/BF/2023.05.15/run_13236/R21-S02/corrected.cov_model_ptc \
#        -p ${CONFIG}/gridFit_corrected-new.yaml \
#            --config isr:connections.newBFKernel='bfk' \
#        --register-dataset-types
...
pipetask run \
        ...
        -b ${REPO} \
        -i u/abrought/BF/2023.04.28/ptc.2023.04.28.R21-S02.trunc_to_pcti,u/abrought/BF/2023.05.15/bfk.2023.05.15.R21-S02.final,${SBIAS},${SDARK},${DEFECTS},${CTI},${LINEARITY},LSSTCam/raw/all \
        -o u/abrought/BF/2023.06.06/run_13238/R21-S02/uncorrected \
        -p ${CONFIG}/gridFit_uncorrected-new.yaml \
            --config isr:connections.newBFKernel='bfk' \
        --register-dataset-types
...
#        -b ${REPO} \
#        -i u/abrought/BF/2023.04.28/ptc.2023.04.28.R21-S02.trunc_to_pcti,u/abrought/BF/2023.05.15/bfk.2023.05.15.R21-S02.final,${SBIAS},${SDARK},${DEFECTS},${CTI},${LINEARITY},LSSTCam/raw/all \
#        -o u/abrought/BF/2023.05.15/run_13238/R21-S02/corrected.optimized_scale_factor \
#        -p ${CONFIG}/gridFit_corrected-new.yaml \
#            --config isr:connections.newBFKernel='bfk' \
#        --register-dataset-types
...
#        -b ${REPO} \
#        -i u/abrought/BF/2023.04.28/ptc.2023.04.28.R21-S02.trunc_to_pcti,u/abrought/BF/2023.05.15/bfk.2023.05.15.R21-S02.cov_model_pcti,${SBIAS},${SDARK},${DEFECTS},${CTI},${LINEARITY},LSSTCam/raw/all \
#        -o u/abrought/BF/2023.05.15/run_13238/R21-S02/corrected.cov_model_pcti \
#        -p ${CONFIG}/gridFit_corrected-new.yaml \
#            --config isr:connections.newBFKernel='bfk' \
#        --register-dataset-types
...
#        -b ${REPO} \
#        -i u/abrought/BF/2023.04.28/ptc.2023.04.28.R21-S02.trunc_to_ptc,u/abrought/BF/2023.05.15/bfk.2023.05.15.R21-S02.cov_model_ptc,${SBIAS},${SDARK},${DEFECTS},${CTI},${LINEARITY},LSSTCam/raw/all \
#        -o u/abrought/BF/2023.05.15/run_13238/R21-S02/corrected.cov_model_ptc \
#        -p ${CONFIG}/gridFit_corrected-new.yaml \
#            --config isr:connections.newBFKernel='bfk' \
#        --register-dataset-types
