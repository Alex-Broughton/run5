...
setup -t w_2023_29 -j -r /sdf/home/a/abrought/alternate_branches/DM-39515/cp_pipe
setup -t w_2023_29 -j -r /sdf/home/a/abrought/alternate_branches/DM-39515/ip_isr
...
#         -o u/abrought/BF/2023.09.15/run_13248/R03-S12/uncorrected \
...
pipetask run \
        ...
        -b ${REPO} \
        -i u/abrought/BF/2023.09.15/ptc.R03-S12.trunc_to_newpcti,u/abrought/BF/2023.09.15/bfk.R03-S12.final,${SBIAS},${SDARK},${DEFECTS},${CTI},${LINEARITY},LSSTCam/raw/all \
        -o u/abrought/BF/2023.09.15/run_13248/R03-S12/corrected.A23.v3 \
        -p ${CONFIG}/cpSpots_corrected_a23.yaml \
            --config isr:connections.newBFKernel='bfk' \
        --register-dataset-types
...
#         -b ${REPO} \
#         -i u/abrought/BF/2023.09.15/ptc.R03-S12.trunc_to_newpcti,u/abrought/BF/2023.09.15/bfk.R03-S12.final,${SBIAS},${SDARK},${DEFECTS},${CTI},${LINEARITY},LSSTCam/raw/all \
#         -o u/abrought/BF/2023.09.15/run_13247/R03-S12/uncorrected \
#         -p ${CONFIG}/cpSpots_uncorrected.yaml \
#             --config isr:connections.newBFKernel='bfk' \
#         --register-dataset-types
...
#         -d "instrument='LSSTCam' AND detector in ( 23 ) AND exposure.observation_type='spot' AND exposure.science_program IN ('13248')" \
#         -b ${REPO} \
#         -i u/abrought/BF/2023.09.15/ptc.R03-S12.trunc_to_newpcti,u/abrought/BF/2023.09.15/bfk.R03-S12.pcti,${SBIAS},${SDARK},${DEFECTS},${CTI},${LINEARITY},LSSTCam/raw/all \
#         -o u/abrought/BF/2023.09.15/run_13248/R03-S12/corrected.pcti.nonFluxConserving \
#         -p ${CONFIG}/cpSpots_corrected_nonFluxConserving.yaml \
#             --config isr:connections.newBFKernel='bfk' \
#         --register-dataset-types
...
#         -b ${REPO} \
#         -i u/abrought/BF/2023.09.15/ptc.R03-S12.trunc_to_newpcti,u/abrought/BF/2023.09.15/bfk.R03-S12.pcti,${SBIAS},${SDARK},${DEFECTS},${CTI},${LINEARITY},LSSTCam/raw/all \
#         -o u/abrought/BF/2023.09.15/run_13248/R03-S12/corrected.pcti.fluxConserving \
#         -p ${CONFIG}/cpSpots_corrected_fluxConserving.yaml \
#             --config isr:connections.newBFKernel='bfk' \
#         --register-dataset-types
...
#         -b ${REPO} \
#         -i u/abrought/BF/2023.09.15/ptc.R03-S12.trunc_to_newpcti,u/abrought/BF/2023.09.15/bfk.R03-S12.pcti,${SBIAS},${SDARK},${DEFECTS},${CTI},${LINEARITY},LSSTCam/raw/all \
#         -o u/abrought/BF/2023.09.15/run_13247/R03-S12/corrected.pcti.nonFluxConserving \
#         -p ${CONFIG}/cpSpots_corrected_nonFluxConserving.yaml \
#             --config isr:connections.newBFKernel='bfk' \
#         --register-dataset-types
...
#         -b ${REPO} \
#         -i u/abrought/BF/2023.09.15/ptc.R03-S12.trunc_to_newpcti,u/abrought/BF/2023.09.15/bfk.R03-S12.pcti,${SBIAS},${SDARK},${DEFECTS},${CTI},${LINEARITY},LSSTCam/raw/all \
#         -o u/abrought/BF/2023.09.15/run_13247/R03-S12/corrected.pcti.fluxConserving \
#         -p ${CONFIG}/cpSpots_corrected_fluxConserving.yaml \
#             --config isr:connections.newBFKernel='bfk' \
#         --register-dataset-types