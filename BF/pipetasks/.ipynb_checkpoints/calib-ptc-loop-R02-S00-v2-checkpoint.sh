...
#SBATCH --output=/sdf/home/a/abrought/run5/BF/output/out100003.txt
#SBATCH --error=/sdf/home/a/abrought/run5/BF/output/err100003.txt
#SBATCH --ntasks=5
...
do
    ...
    pipetask run  \
        ...
        -b ${REPO} \
        -i u/abrought/BF/2023.07.19/ptc.R02-S00.trunc_to_pcti.fullnoisematrix,u/abrought/BF/2023.10.09/bfk.R02-S00.${i}adu.newpcti,${SBIAS},${SDARK},${DEFECTS},${CTI},${LINEARITY},LSSTCam/raw/all \
        -o u/abrought/BF/2023.10.09/ptc.R02-S00.bfcorrected.${i}adu.newpcti.nonFluxConserving.bfThreshold10 \
