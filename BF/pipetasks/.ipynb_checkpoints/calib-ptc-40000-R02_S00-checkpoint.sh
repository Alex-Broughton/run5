...
pipetask run  \
    ...
    -b ${REPO} \
    -i u/abrought/BF/2023.04.28/ptc.2023.04.28.R02-S00.trunc_to_pcti,u/abrought/BF/2023.05.15/bfk.2023.05.15.R02-S00.cov_model_40000adu.noForceZeroSum,${SBIAS},${SDARK},${DEFECTS},${CTI},${LINEARITY},LSSTCam/raw/all \
    -o u/abrought/BF/2023.05.15/ptc.2023.05.15.R02-S00.bfcorrected.cov_model_40000adu.noForceZeroSum \
    -p ${CONFIG}/cpPtc.yaml \
