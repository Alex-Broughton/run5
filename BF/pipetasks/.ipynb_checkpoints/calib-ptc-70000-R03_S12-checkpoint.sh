...
#SBATCH --output=/sdf/home/a/abrought/run5/BF/output/out18.txt
#SBATCH --error=/sdf/home/a/abrought/run5/BF/output/err18.txt
#SBATCH --ntasks=6
...
pipetask run  \
    ...
    -b ${REPO} \
    -i u/abrought/BF/2023.04.28/ptc.2023.04.28.R03-S12.trunc_to_pcti,u/abrought/BF/2023.05.15/bfk.2023.05.15.R03-S12.cov_model_70000adu.noForceZeroSum,${SBIAS},${SDARK},${DEFECTS},${CTI},${LINEARITY},LSSTCam/raw/all \
    -o u/abrought/BF/2023.05.15/ptc.2023.05.15.R03-S12.bfcorrected.cov_model_70000adu.noForceZeroSum \
    -p ${CONFIG}/cpPtc.yaml \
