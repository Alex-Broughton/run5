...
#SBATCH --output=/sdf/home/a/abrought/run5/BF/output/out02.txt
#SBATCH --error=/sdf/home/a/abrought/run5/BF/output/err02.txt
#SBATCH --ntasks=6
...
pipetask run  \
    ...
    -o u/abrought/BF/2023.06.06/ptc.2023.06.06.R03-S12.bfcorrected.final \
    -p ${CONFIG}/cpPtc-corrected.yaml \
        --config isr:connections.newBFKernel='bfk' \
    --register-dataset-types
...
pipetask run  \
    ...
    -o u/abrought/BF/2023.06.06/ptc.2023.06.06.R24-S11.bfcorrected.final \
    -p ${CONFIG}/cpPtc-corrected.yaml \
        --config isr:connections.newBFKernel='bfk' \
    --register-dataset-types
...
pipetask run  \
    ...
    -o u/abrought/BF/2023.06.06/ptc.2023.06.06.R02-S00.bfcorrected.final \
    -p ${CONFIG}/cpPtc-corrected.yaml \
        --config isr:connections.newBFKernel='bfk' \
    --register-dataset-types
...
pipetask run  \
    ...
    -o u/abrought/BF/2023.06.06/ptc.2023.06.06.R21-S02.bfcorrected.final \
    -p ${CONFIG}/cpPtc-corrected.yaml \
        --config isr:connections.newBFKernel='bfk' \
    --register-dataset-types