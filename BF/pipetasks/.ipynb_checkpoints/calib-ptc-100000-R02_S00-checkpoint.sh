...
pipetask run  \
    ...
    -b ${REPO} \
    -i u/abrought/BF/2023.06.16/ptc.R02-S00.trunc_to_pcti,u/abrought/BF/2023.06.16/bfk.2023.06.16.R02-S00.cov_model_100000adu.noForceZeroSum,${SBIAS},${SDARK},${DEFECTS},${CTI},${LINEARITY},LSSTCam/raw/all \
    -o u/abrought/BF/2023.06.16/ptc.2023.06.16.R02-S00.bfcorrected.cov_model_100000adu.noForceZeroSum \
    -p ${CONFIG}/cpPtc.yaml \
