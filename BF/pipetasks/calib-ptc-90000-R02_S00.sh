...
#SBATCH --output=/sdf/home/a/abrought/run5/BF/output/out25.txt
#SBATCH --error=/sdf/home/a/abrought/run5/BF/output/err25.txt
#SBATCH --ntasks=6
...
pipetask run  \
    ...
    -b ${REPO} \
    -i u/abrought/BF/2023.04.28/ptc.2023.04.28.R02-S00.trunc_to_pcti,u/abrought/BF/2023.05.15/bfk.2023.05.15.R02-S00.cov_model_90000adu.noForceZeroSum,${SBIAS},${SDARK},${DEFECTS},${CTI},${LINEARITY},LSSTCam/raw/all \
    -o u/abrought/BF/2023.05.15/ptc.2023.05.15.R02-S00.bfcorrected.cov_model_90000adu.noForceZeroSum \
    -p ${CONFIG}/cpPtc.yaml \
