...
#     -o u/abrought/BF/2023.09.15/ptc.R03-S12.bfcorrected.final.nonFluxConserving.fullcovariance \
...
pipetask run  \
    ...
    -o u/abrought/BF/2023.10.09/ptc.R24-S11.bfcorrected.final.nonFluxConserving \
    -p ${CONFIG}/cpPtc2.yaml \
        --config isr:connections.newBFKernel='bfk' \
    --register-dataset-types
...
pipetask run  \
    ...
    -b ${REPO} \
    -i u/abrought/BF/2023.07.19/ptc.R21-S02.trunc_to_pcti.fullnoisematrix,u/abrought/BF/2023.10.09/bfk.R21-S02.final,${SBIAS},${SDARK},${DEFECTS},${CTI},${LINEARITY},LSSTCam/raw/all \
    -o u/abrought/BF/2023.10.09/ptc.R21-S02.bfcorrected.final.nonFluxConserving \
    -p ${CONFIG}/cpPtc2.yaml \
        --config isr:connections.newBFKernel='bfk' \
    --register-dataset-types
