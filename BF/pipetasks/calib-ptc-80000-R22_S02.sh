...
#SBATCH --output=/sdf/home/a/abrought/run5/BF/output/out23.txt
#SBATCH --error=/sdf/home/a/abrought/run5/BF/output/err23.txt
#SBATCH --ntasks=6
...
pipetask run  \
    ...
    -b ${REPO} \
    -i u/abrought/BF/2023.04.28/ptc.2023.04.28.R21-S02.trunc_to_pcti,u/abrought/BF/2023.05.15/bfk.2023.05.15.R21-S02.cov_model_80000adu.noForceZeroSum,${SBIAS},${SDARK},${DEFECTS},${CTI},${LINEARITY},LSSTCam/raw/all \
    -o u/abrought/BF/2023.05.15/ptc.2023.05.15.R21-S02.bfcorrected.cov_model_80000adu.noForceZeroSum \
    -p ${CONFIG}/cpPtc.yaml \
