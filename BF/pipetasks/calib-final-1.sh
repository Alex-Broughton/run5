...
#        -b ${REPO} \
#        -i ${SBIAS},${SDARK},${DEFECTS},${LINEARITY},${CTI},LSSTCam/raw/all \
#        -o u/abrought/BF/2023.07.19/ptc.R03-S12.fullnoisematrix \
...
pipetask run  \
    ...
    -b ${REPO} \
    -i ${SBIAS},${SDARK},${DEFECTS},${LINEARITY},${CTI},LSSTCam/raw/all \
    -o u/abrought/BF/2023.10.09/ptc.R03-S12.trunc_to_pcti \
...
#      -b ${REPO} \
#      -i ${SBIAS},${SDARK},${DEFECTS},${LINEARITY},${CTI},LSSTCam/raw/all \
#      -o u/abrought/BF/2023.07.19/ptc.R21-S02.fullnoisematrix \
#      -p ${CONFIG}/cpPtc-full.yaml \
#      --register-dataset-types
