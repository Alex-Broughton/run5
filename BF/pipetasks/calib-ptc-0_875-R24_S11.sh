...
#SBATCH --output=/sdf/home/a/abrought/run5/BF/output/out045.txt
#SBATCH --error=/sdf/home/a/abrought/run5/BF/output/err045.txt
#SBATCH --ntasks=6
...
pipetask run  \
    ...
    -b ${REPO} \
    -i u/abrought/BF/2023.04.28/ptc.2023.04.28.R24-S11.trunc_to_pcti,u/abrought/BF/2023.05.15/bfk.2023.05.15.R24-S11.fudgefactor_0.875,${SBIAS},${SDARK},${DEFECTS},${CTI},${LINEARITY},LSSTCam/raw/all \
    -o u/abrought/BF/2023.06.06/ptc.2023.06.06.R24-S11.bfcorrected.fudgefactor_0.875 \
    -p ${CONFIG}/cpPtc.yaml \
...
#    -b ${REPO} \
#    -i u/abrought/BF/2023.04.28/ptc.2023.04.28.R03-S12.trunc_to_pcti,u/abrought/BF/2023.05.15/bfk.2023.05.15.R03-S12.fudgefactor_0.875,${SBIAS},${SDARK},${DEFECTS},${CTI},${LINEARITY},LSSTCam/raw/all \
#    -o u/abrought/BF/2023.06.06/ptc.2023.06.06.R03-S12.bfcorrected.fudgefactor_0.875 \
#    -p ${CONFIG}/cpPtc.yaml \
#        --config isr:connections.newBFKernel='bfk' \
#    --register-dataset-types
#
...
#    -b ${REPO} \
#    -i u/abrought/BF/2023.04.28/ptc.2023.04.28.R02-S00.trunc_to_pcti,u/abrought/BF/2023.05.15/bfk.2023.05.15.R02-S00.fudgefactor_0.875,${SBIAS},${SDARK},${DEFECTS},${CTI},${LINEARITY},LSSTCam/raw/all \
#    -o u/abrought/BF/2023.06.06/ptc.2023.06.06.R02-S00.bfcorrected.fudgefactor_0.875 \
#    -p ${CONFIG}/cpPtc.yaml \
#        --config isr:connections.newBFKernel='bfk' \
#    --register-dataset-types
#
...
#    -b ${REPO} \
#    -i u/abrought/BF/2023.04.28/ptc.2023.04.28.R21-S02.trunc_to_pcti,u/abrought/BF/2023.05.15/bfk.2023.05.15.R21-S02.fudgefactor_0.875,${SBIAS},${SDARK},${DEFECTS},${CTI},${LINEARITY},LSSTCam/raw/all \
#    -o u/abrought/BF/2023.06.06/ptc.2023.06.06.R21-S02.bfcorrected.fudgefactor_0.875 \
#    -p ${CONFIG}/cpPtc.yaml \
#        --config isr:connections.newBFKernel='bfk' \
#    --register-dataset-types
