...
#SBATCH --output=/sdf/home/a/abrought/run5/BF/output/out329.txt
#SBATCH --error=/sdf/home/a/abrought/run5/BF/output/err329.txt
#SBATCH --ntasks=6
...
pipetask run \
       ...
       -o u/abrought/BF/2023.07.19/bfk.R21-S02.10000adu.zersumoff \
       -p ${CONFIG}/cpBfkSolve-10000-R21-S02.yaml \
...
pipetask run \
       ...
       -b ${REPO} \
       -i u/abrought/BF/2023.07.19/ptc.R21-S02.trunc_to_pcti.fullnoisematrix,${SBIAS},${SDARK},${DEFECTS},${LINEARITY},${CTI} \
       -o u/abrought/BF/2023.07.19/bfk.R21-S02.20000adu.zersumoff \
       -p ${CONFIG}/cpBfkSolve-20000-R21-S02.yaml \
       --register-dataset-types
...
pipetask run \
       ...
       -b ${REPO} \
       -i u/abrought/BF/2023.07.19/ptc.R21-S02.trunc_to_pcti.fullnoisematrix,${SBIAS},${SDARK},${DEFECTS},${LINEARITY},${CTI} \
       -o u/abrought/BF/2023.07.19/bfk.R21-S02.30000adu.zersumoff \
       -p ${CONFIG}/cpBfkSolve-30000-R21-S02.yaml \
       --register-dataset-types
...
pipetask run \
       ...
       -b ${REPO} \
       -i u/abrought/BF/2023.07.19/ptc.R21-S02.trunc_to_pcti.fullnoisematrix,${SBIAS},${SDARK},${DEFECTS},${LINEARITY},${CTI} \
       -o u/abrought/BF/2023.07.19/bfk.R21-S02.40000adu.zersumoff \
       -p ${CONFIG}/cpBfkSolve-40000-R21-S02.yaml \
       --register-dataset-types
...
pipetask run \
       ...
       -b ${REPO} \
       -i u/abrought/BF/2023.07.19/ptc.R21-S02.trunc_to_pcti.fullnoisematrix,${SBIAS},${SDARK},${DEFECTS},${LINEARITY},${CTI} \
       -o u/abrought/BF/2023.07.19/bfk.R21-S02.50000adu.zersumoff \
       -p ${CONFIG}/cpBfkSolve-50000-R21-S02.yaml \
       --register-dataset-types
...
pipetask run \
       ...
       -b ${REPO} \
       -i u/abrought/BF/2023.07.19/ptc.R21-S02.trunc_to_pcti.fullnoisematrix,${SBIAS},${SDARK},${DEFECTS},${LINEARITY},${CTI} \
       -o u/abrought/BF/2023.07.19/bfk.R21-S02.60000adu.zersumoff \
       -p ${CONFIG}/cpBfkSolve-60000-R21-S02.yaml \
       --register-dataset-types
...
pipetask run \
       ...
       -b ${REPO} \
       -i u/abrought/BF/2023.07.19/ptc.R21-S02.trunc_to_pcti.fullnoisematrix,${SBIAS},${SDARK},${DEFECTS},${LINEARITY},${CTI} \
       -o u/abrought/BF/2023.07.19/bfk.R21-S02.70000adu.zersumoff \
       -p ${CONFIG}/cpBfkSolve-70000-R21-S02.yaml \
       --register-dataset-types
...
pipetask run \
       ...
       -b ${REPO} \
       -i u/abrought/BF/2023.07.19/ptc.R21-S02.trunc_to_pcti.fullnoisematrix,${SBIAS},${SDARK},${DEFECTS},${LINEARITY},${CTI} \
       -o u/abrought/BF/2023.07.19/bfk.R21-S02.80000adu.zersumoff \
       -p ${CONFIG}/cpBfkSolve-80000-R21-S02.yaml \
       --register-dataset-types
...
#        -b ${REPO} \
#        -i u/abrought/BF/2023.07.19/ptc.R21-S02.trunc_to_pcti.fullnoisematrix,${SBIAS},${SDARK},${DEFECTS},${LINEARITY},${CTI} \
#        -o u/abrought/BF/2023.07.19/bfk.R21-S02.90000adu \
#        -p ${CONFIG}/cpBfkSolve-90000-R21-S02.yaml \
#        --register-dataset-types
...
#        -b ${REPO} \
#        -i u/abrought/BF/2023.07.19/ptc.R21-S02.trunc_to_pcti.fullnoisematrix,${SBIAS},${SDARK},${DEFECTS},${LINEARITY},${CTI} \
#        -o u/abrought/BF/2023.07.19/bfk.R21-S02.100000adu \
#        -p ${CONFIG}/cpBfkSolve-100000-R21-S02.yaml \
#        --register-dataset-types
