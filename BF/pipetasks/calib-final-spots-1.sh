...
pipetask run \
        ...
        -b ${REPO} \
        -i u/abrought/BF/2023.07.19/ptc.2023.07.19.R03-S12.trunc_to_pcti.fullnoisematrix,u/abrought/BF/2023.07.19/bfk.R03-S12.final,${SBIAS},${SDARK},${DEFECTS},${CTI},${LINEARITY},LSSTCam/raw/all \
        -o u/abrought/BF/2023.06.06/run_13248/R03-S12/uncorrected \
...
pipetask run \
        ...
        -o u/abrought/BF/2023.06.06/run_13248/R03-S12/corrected.optimized_scale_factor \
...
#        -b ${REPO} \
#        -i u/abrought/BF/2023.04.28/ptc.2023.04.28.R03-S12.trunc_to_pcti,u/abrought/BF/2023.05.15/bfk.2023.05.15.R03-S12.final,${SBIAS},${SDARK},${DEFECTS},${CTI},${LINEARITY},LSSTCam/raw/all \
#        -o u/abrought/BF/2023.05.15/run_13247/R03-S12/corrected.optimized_scale_factor \
#        -p ${CONFIG}/gridFit_corrected-new.yaml \
#            --config isr:connections.newBFKernel='bfk' \
#        --register-dataset-types
...
#        -d "instrument='LSSTCam' AND detector in ( 23 ) AND exposure.observation_type='spot' AND exposure.science_program IN ('13248')" \
#        -b ${REPO} \
#        -i u/abrought/BF/2023.04.28/ptc.2023.04.28.R03-S12.trunc_to_pcti,u/abrought/BF/2023.05.15/bfk.2023.05.15.R03-S12.cov_model_pcti,${SBIAS},${SDARK},${DEFECTS},${CTI},${LINEARITY},LSSTCam/raw/all \
#        -o u/abrought/BF/2023.05.15/run_13248/R03-S12/corrected.cov_model_pcti \
#        -p ${CONFIG}/gridFit_corrected-new.yaml \
#            --config isr:connections.newBFKernel='bfk' \
#        --register-dataset-types
...
#        -d "instrument='LSSTCam' AND detector in ( 23 ) AND exposure.observation_type='spot' AND exposure.science_program IN ('13248')" \
#        -b ${REPO} \
#        -i u/abrought/BF/2023.04.28/ptc.2023.04.28.R03-S12.trunc_to_ptc,u/abrought/BF/2023.05.15/bfk.2023.05.15.R03-S12.cov_model_ptc,${SBIAS},${SDARK},${DEFECTS},${CTI},${LINEARITY},LSSTCam/raw/all \
#        -o u/abrought/BF/2023.05.15/run_13248/R03-S12/corrected.cov_model_ptc \
#        -p ${CONFIG}/gridFit_corrected-new.yaml \
#            --config isr:connections.newBFKernel='bfk' \
#        --register-dataset-types
...
pipetask run \
        ...
        -b ${REPO} \
        -i u/abrought/BF/2023.04.28/ptc.2023.04.28.R03-S12.trunc_to_pcti,u/abrought/BF/2023.05.15/bfk.2023.05.15.R03-S12.final,${SBIAS},${SDARK},${DEFECTS},${CTI},${LINEARITY},LSSTCam/raw/all \
        -o u/abrought/BF/2023.06.06/run_13247/R03-S12/uncorrected \
        -p ${CONFIG}/gridFit_uncorrected-new.yaml \
            --config isr:connections.newBFKernel='bfk' \
        --register-dataset-types
...
pipetask run \
        ...
        -b ${REPO} \
        -i u/abrought/BF/2023.04.28/ptc.2023.04.28.R03-S12.trunc_to_pcti,u/abrought/BF/2023.05.15/bfk.2023.05.15.R03-S12.final,${SBIAS},${SDARK},${DEFECTS},${CTI},${LINEARITY},LSSTCam/raw/all \
        -o u/abrought/BF/2023.06.06/run_13247/R03-S12/corrected.optimized_scale_factor \
        -p ${CONFIG}/gridFit_corrected-new.yaml \
            --config isr:connections.newBFKernel='bfk' \
        --register-dataset-types
...
#        -b ${REPO} \
#        -i u/abrought/BF/2023.04.28/ptc.2023.04.28.R03-S12.trunc_to_pcti,u/abrought/BF/2023.05.15/bfk.2023.05.15.R03-S12.cov_model_pcti,${SBIAS},${SDARK},${DEFECTS},${CTI},${LINEARITY},LSSTCam/raw/all \
#        -o u/abrought/BF/2023.05.15/run_13247/R03-S12/corrected.cov_model_pcti \
#        -p ${CONFIG}/gridFit_corrected-new.yaml \
#            --config isr:connections.newBFKernel='bfk' \
#        --register-dataset-types
...
#        -b ${REPO} \
#        -i u/abrought/BF/2023.04.28/ptc.2023.04.28.R03-S12.trunc_to_ptc,u/abrought/BF/2023.05.15/bfk.2023.05.15.R03-S12.cov_model_ptc,${SBIAS},${SDARK},${DEFECTS},${CTI},${LINEARITY},LSSTCam/raw/all \
#        -o u/abrought/BF/2023.05.15/run_13247/R03-S12/corrected.cov_model_ptc \
#        -p ${CONFIG}/gridFit_corrected-new.yaml \
#            --config isr:connections.newBFKernel='bfk' \
#        --register-dataset-types
