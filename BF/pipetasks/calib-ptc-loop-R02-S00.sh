...
do
    ...
    pipetask run  \
        ...
        -b ${REPO} \
        -i u/abrought/BF/2023.07.19/ptc.R02-S00.trunc_to_pcti.fullnoisematrix,u/abrought/BF/2023.07.19/bfk.R02-S00.${i}adu,${SBIAS},${SDARK},${DEFECTS},${CTI},${LINEARITY},LSSTCam/raw/all \
        -o u/abrought/BF/2023.07.19/ptc.R02-S00.bfcorrected.${i}adu.newpcti.fluxConserving.bfThreshold10 \
        -p ${CONFIG}/cpPtc.yaml \
