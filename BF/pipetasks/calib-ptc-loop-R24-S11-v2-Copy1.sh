...
#SBATCH --output=/sdf/home/a/abrought/run5/BF/output/out100002-3.txt
#SBATCH --error=/sdf/home/a/abrought/run5/BF/output/err100002-3.txt
#SBATCH --ntasks=5
...
do
    ...
    pipetask run  \
        ...
        -b ${REPO} \
        -i u/abrought/BF/2023.10.09/ptc.R24-S11.trunc_to_pcti,u/abrought/BF/2023.10.09/bfk.R24-S11.${i}adu.newpcti,${SBIAS},${SDARK},${DEFECTS},${CTI},${LINEARITY},LSSTCam/raw/all \
        -o u/abrought/BF/2023.10.09/ptc.R24-S11.bfcorrected.${i}adu.newpcti.nonFluxConserving.bfThreshold10 \
