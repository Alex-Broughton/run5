...
#SBATCH --output=/sdf/home/a/abrought/run5/BF/output/out100003-6.txt
#SBATCH --error=/sdf/home/a/abrought/run5/BF/output/err100003-6.txt
#SBATCH --ntasks=5
...
pipetask run  \
        ...
        -b ${REPO} \
        -i u/abrought/BF/2023.07.19/ptc.R02-S00.trunc_to_pcti.fullnoisematrix,u/abrought/BF/2023.10.09/bfk.R02-S00.10000adu.newpcti,${SBIAS},${SDARK},${DEFECTS},${CTI},${LINEARITY},LSSTCam/raw/all \
        -o u/abrought/BF/2023.10.09/ptc.R02-S00.bfcorrected.10000adu.newpcti.nonFluxConserving.bfThreshold10 \
...
pipetask run  \
        ...
        -d "instrument='LSSTCam' AND detector IN (9) AND exposure.science_program IN ('13144')  AND exposure.observation_type = 'flat' AND exposure.observation_reason='flat' " \
        -b ${REPO} \
        -i u/abrought/BF/2023.07.19/ptc.R02-S00.trunc_to_pcti.fullnoisematrix,u/abrought/BF/2023.10.09/bfk.R02-S00.40000adu.newpcti,${SBIAS},${SDARK},${DEFECTS},${CTI},${LINEARITY},LSSTCam/raw/all \
        -o u/abrought/BF/2023.10.09/ptc.R02-S00.bfcorrected.40000adu.newpcti.nonFluxConserving.bfThreshold10 \
        -p ${CONFIG}/cpPtc2.yaml \
            --config isr:connections.newBFKernel='bfk' \
        --register-dataset-types
