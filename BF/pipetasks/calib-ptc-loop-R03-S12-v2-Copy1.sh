...
#SBATCH --output=/sdf/home/a/abrought/run5/BF/output/out100001-5.txt
#SBATCH --error=/sdf/home/a/abrought/run5/BF/output/err100001-5.txt
#SBATCH --ntasks=5
...
do
    ...
    pipetask run  \
        ...
        -b ${REPO} \
        -i u/abrought/BF/2023.10.09/ptc.R03-S12.trunc_to_pcti,u/abrought/BF/2023.10.09/bfk.R03-S12.${i}adu.newpcti,${SBIAS},${SDARK},${DEFECTS},${CTI},${LINEARITY},LSSTCam/raw/all \
        -o u/abrought/BF/2023.10.09/ptc.R03-S12.bfcorrected.${i}adu.newpcti.nonFluxConserving.bfThreshold10 \
