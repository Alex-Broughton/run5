...
do
    ...
    pipetask run  \
        ...
        -b ${REPO} \
        -i u/abrought/BF/2023.09.15/ptc.R03-S12.trunc_to_newpcti,u/abrought/BF/2023.09.15/bfk.R03-S12.${i}adu.newpcti,${SBIAS},${SDARK},${DEFECTS},${CTI},${LINEARITY},LSSTCam/raw/all \
        -o u/abrought/BF/2023.09.15/ptc.R03-S12.bfcorrected.${i}adu.newpcti.fluxConserving.bfThreshold10 \
        -p ${CONFIG}/cpPtc.yaml \
