...
pipetask run \
    -j 25 \
    -d "instrument='LSST-TS8' AND exposure.science_program IN ('7016D') AND detector in (94) AND exposure.observation_type = 'flat' AND exposure.observation_reason='sflat' " \
    -b ${REPO} \
