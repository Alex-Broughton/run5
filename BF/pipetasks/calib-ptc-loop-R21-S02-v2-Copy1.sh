...
#SBATCH --output=/sdf/home/a/abrought/run5/BF/output/out100004-4.txt
#SBATCH --error=/sdf/home/a/abrought/run5/BF/output/err100004-4.txt
#SBATCH --ntasks=5
...
pipetask run  \
        ...
        -b ${REPO} \
        -i u/abrought/BF/2023.07.19/ptc.R21-S02.trunc_to_pcti.fullnoisematrix,u/abrought/BF/2023.10.09/bfk.R21-S02.20000adu.newpcti,${SBIAS},${SDARK},${DEFECTS},${CTI},${LINEARITY},LSSTCam/raw/all \
        -o u/abrought/BF/2023.10.09/ptc.R21-S02.bfcorrected.20000adu.newpcti.nonFluxConserving.bfThreshold10 \
