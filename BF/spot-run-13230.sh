...
#SBATCH --job-name=spot-run-13230
#SBATCH --output=/sdf/home/a/abrought/run5/BF/output/spotout-run-13230.txt
#SBATCH --error=/sdf/home/a/abrought/run5/BF/output/spoterr-run-13230.txt
#SBATCH --ntasks=1
...
pipetask run \
        ...
        -o u/abrought/BF/run_13230/R02_S00/corrected \
        -p ${YAML}/gridFit.yaml \
        --register-dataset-types
 
cp ${YAML}/gridFit.yaml ${REPO}/u/abrought/BF/run_13230/R02_S00/corrected
...
pipetask run \
        ...
        -b ${REPO}/butler.yaml \
        -i LSSTCam/raw/all,LSSTCam/calib,${sbias},${sdark},${sflat},${defects},${ptcs},${bfks} \
        -o u/abrought/BF/run_13230/R02_S00/uncorrected \
        -p ${YAML}/gridFit2.yaml \
        --register-dataset-types
 
cp ${YAML}/gridFit2.yaml ${REPO}/u/abrought/BF/run_13230/R02_S00/uncorrected
