...
#
#SBATCH --job-name=spotcopy
#SBATCH --output=/sdf/home/a/abrought/run5/BF/output/spotcopyout.txt
#SBATCH --error=/sdf/home/a/abrought/run5/BF/output/spotcopyerr.txt
#SBATCH --ntasks=1
...
pipetask run \
        ...
        -o u/abrought/BF/run_13230/R02_S00/corrected_linearized \
